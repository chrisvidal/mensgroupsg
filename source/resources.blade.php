    ...
    <div class="section__content">
        <div class="g">
            <div class="g-item g-item--lg">
                <h1 class="h1">Documentary, curated articles about men's work, books,...</h1>
...
<section class="section intro intro--full" id="why">
    <div class="section__content">
        <div class="g">
            <div class="g-item g-item--lg">
                <div class="title">Curated articles about men's work</div>
                <p class="push-top--large">Articles worth your time:</p>
                <ul class="ul description push-top ">
                    <li># <a target="_blank" href="https://medium.com/personal-growth-lab/why-you-shouldnt-go-on-your-self-improvement-journey-alone-257361ac5237">Find your tribe</a></li>
